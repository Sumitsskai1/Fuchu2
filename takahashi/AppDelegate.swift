            ...
            Form {
                ...
                if isNewTaskSelected {
                    ...
                    Section(header: Text("New Subtask")) {
                        ...
                        TextField("Memo", text: $newSubtaskMemo)
                        Picker("Notification Time", selection: $notificationTimeIndex) {
                ...
                Section {
                    Button(action: {
                        ...
                        HStack {
                            Spacer()
                            Text("Add \(isNewTaskSelected ? "Task" : "Subtask")")
                                .foregroundColor(.white)
                            Spacer()
                        }
                        .padding()
                        .frame(height: 44)
                        .background(appThemeColor) // カラーテーマを適用
                        .cornerRadius(8)
                        .padding()
                    }
                }
